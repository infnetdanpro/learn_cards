...
def category_words(category_id, page=1):
    ...
    paginate_cards = (
        ...
        .filter(Card.id.in_(cards))
        .order_by(ordering(text(f"Card.{column}")))
    ...
    return render_template(
        template_name, cards=paginate_cards, category_id=category_id, exam=exam
    )
